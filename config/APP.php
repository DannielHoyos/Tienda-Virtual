<?php
	...
	----------*/
	const SERVERURL="http://localhost/storetienda/";


	/*----------  
	Nombre de la empresa o compañia -  Company or company name
	----------*/
	const COMPANY="TO MY STORE";
	...
	/*----------  Direccion - Address  ----------*/
	const COUNTRY="Colombia-Bogotá";
	const ADDRESS="Avenida siempreviva 742";
	

	/*----------  Configuración de moneda - Currency Settings  ----------*/
	const COIN_SYMBOL="$";
	const COIN_NAME="COP";
	const COIN_DECIMALS="6.0";
	const COIN_SEPARATOR_THOUSAND=".";
	const COIN_SEPARATOR_DECIMAL=".";


	/*----------  Tipos de documentos - Document types ----------*/
	const DOCUMENTS_USERS=["Cedula","Nit","Licencia","Pasaporte","Otro"];
	const DOCUMENTS_COMPANY=["Cedula","RUT","NIT","RUC","Otro"];
