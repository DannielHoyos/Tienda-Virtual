                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-outline mb-4">
                                    ...
                                    <label for="cliente_provincia" class="form-label">Pais, Ciudad o Departamento o<?php echo FIELD_OBLIGATORY; ?></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-outline mb-4">
                                    ...
                                    <label for="cliente_ciudad" class="form-label">Ciudad o Barrio <?php echo FIELD_OBLIGATORY; ?></label>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-outline mb-4">
                                    ...
                                    <label for="cliente_direccion" class="form-label">Dirección <?php echo FIELD_OBLIGATORY; ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
